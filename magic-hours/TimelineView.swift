	...
	*/
	...
	fileprivate func setupContent(){
		...
		for element in timeFrames{
			let v = blockForTimeFrame(element, imageTag: i, drawLine: i != timeFrames.count - 1)
			addSubview(v)
			addConstraints([
...
//		addConstraint(NSLayoutConstraint(item: viewFromAbove, attribute: .bottom, relatedBy: .equal, toItem: self, attribute: .bottom, multiplier: 1.0, constant: 0))
	...
	fileprivate func blockForTimeFrame(_ element: TimeFrame, imageTag: Int, drawLine: Bool) -> UIView
	{
...
//		let space = UIView();
//		space.backgroundColor = UIColor.black;
//		v.addSubview(space);
//		
//		v.addConstraints([
//			NSLayoutConstraint(item: space, attribute: .left, relatedBy: .equal, toItem: v, attribute: .left, multiplier: 1.0, constant: 0),
//			NSLayoutConstraint(item: space, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .width, multiplier: 1.0, constant: 25),
//			NSLayoutConstraint(item: space, attribute: .top, relatedBy: .equal, toItem: v, attribute: .top, multiplier: 1.0, constant: 0),
//			NSLayoutConstraint(item: space, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .height, multiplier: 1.0, constant: 50)
		...
		if (element.image != nil)
		{
			...
			v.addConstraints([
				NSLayoutConstraint(item: imageView, attribute: .left, relatedBy: .equal, toItem: v, attribute: .left, multiplier: 1.0, constant: 78),
				NSLayoutConstraint(item: imageView, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .width, multiplier: 1.0, constant: 25),
				NSLayoutConstraint(item: imageView, attribute: .top, relatedBy: .equal, toItem: v, attribute: .top, multiplier: 1.0, constant: -7),
				NSLayoutConstraint(item: imageView, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .height, multiplier: 1.0, constant: 25)
				])
		...
		else
		{
			...
			v.addConstraint(NSLayoutConstraint(item: bullet, attribute: .left, relatedBy: .equal, toItem: v, attribute: .left, multiplier: 1.0, constant: 100))
		...
		v.addConstraints([
			...
			v.addConstraint(NSLayoutConstraint(item: titleLabel, attribute: .left, relatedBy: .equal, toItem: v, attribute: .left, multiplier: 1.0, constant: 10))
		...
		v.addConstraints([
			...
			NSLayoutConstraint(item: textLabel, attribute: .top, relatedBy: .equal, toItem: v, attribute: .top, multiplier: 1.0, constant: 0),
			])
		
			v.addConstraint(NSLayoutConstraint(item: textLabel, attribute: .left, relatedBy: .equal, toItem: v, attribute: .left, multiplier: 1.0, constant: 120))
...
//		} else
		...
		if (drawLine)
		{
			...
			v.addConstraints([
				NSLayoutConstraint(item: line, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: 1),
				NSLayoutConstraint(item: line, attribute: .top, relatedBy: .equal, toItem: v, attribute: .top, multiplier: 1.0, constant: 18),
				NSLayoutConstraint(item: line, attribute: .height, relatedBy: .equal, toItem: v, attribute: .height, multiplier: 1.0, constant: -14)
				])
		
				v.addConstraint(NSLayoutConstraint(item: line, attribute: .left, relatedBy: .equal, toItem: v, attribute: .left, multiplier: 1.0, constant: 90));
		}
